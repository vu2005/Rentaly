...
if (isset($_SESSION['user_id'])) {
    ...
    // SQL query to retrieve booking details including related car information
    $sql = "
        SELECT 
            bookings.booking_id,
            cars.name AS car_name,
            bookings.pick_up_location,
            bookings.destination,
            bookings.pick_up_date,
...
<?php
        ...
        echo '<tr><td colspan="7" style="text-align:center; padding:20px">No transactions yet</td></tr>';
    }
} else {
